      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border:1px solid #e8e4dc;">
        ...
        <tr><td style="padding:40px;">
          ...
          <p style="margin:0 0 20px;font-size:15px;color:#4a5568;line-height:1.7;">
            Obrigado por seu interesse. Aqui está o seu acesso exclusivo ao 
            <strong>Manual Completo de Crédito Rural 2026</strong>.
          </p>
          <table cellpadding="0" cellspacing="0" style="margin:30px 0;">
            <tr><td style="background:#c9a96e;padding:14px 36px;">
              <a href="${downloadUrl}" style="color:#1a1f2e;font-size:13px;font-weight:700;text-decoration:none;letter-spacing:1px;text-transform:uppercase;font-family:Arial,sans-serif;">
                Baixar Manual (PDF)
              </a>
            </td></tr>
          </table>
          <p style="margin:0 0 10px;font-size:13px;color:#a0aec0;line-height:1.5;">
            Este link expira em 24 horas. Caso precise de um novo acesso, 
        ...
        <tr><td style="padding:20px 40px;background:#f7f5f0;border-top:1px solid #e8e4dc;">
          <p style="margin:0;font-size:11px;color:#a0aec0;text-align:center;">
            © 2026 Melazzo Consultoria — Uberaba &amp; Uberlândia, MG
          </p>
        </td></tr>
      </table>
    </td></tr>
